...
if (latestSubscription && (latestSubscription.id === idStr || latestSubscription._id === idStr)) {
...
// fallback to cached
const subscription = subscriptions.find(sub => String(sub.id) === idStr || String(sub._id) === idStr);
if (subscription) {
