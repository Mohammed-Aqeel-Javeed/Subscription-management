                ...
                {isLoading ? (
                  ...
                  <>
                      ...
                      return (
                        ...
                        >
                          <TableCell className="px-3 py-3 font-medium text-gray-800">
                            <span className="block truncate max-w-[250px]" title={filingName || ""}>
                              {filingName || "—"}
                            </span>
                          </TableCell>
                    ...
                    <TableRow className="bg-gray-100 border-t-2 border-gray-300">
                      <TableCell colSpan={5} className="text-lg font-bold text-gray-900 py-4">
                        Grand Total
                      </TableCell>
                      <TableCell className="text-left text-lg font-bold text-indigo-600 py-4">{upcoming.length}</TableCell>
                    </TableRow>
                  </>
                )}
              </TableBody>
