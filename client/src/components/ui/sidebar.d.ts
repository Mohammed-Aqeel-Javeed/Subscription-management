...
declare const SidebarSeparator: React.ForwardRefExoticComponent<Omit<Omit<Omit<any, "ref">, "ref"> & React.RefAttributes<unknown>, "ref"> & React.RefAttributes<unknown>>;
...
declare const SidebarMenuItems: () => import("react/jsx-runtime").JSX.Element;
