...
var Button2 = React.forwardRef(function (_a, ref) {
    var className = _a.className, variant = _a.variant, size = _a.size, /* asChild = false, */ props = __rest(_a, ["className", "variant", "size"]);
    // Radix Slot is not compatible with React 18+ and TypeScript here; always render a button
    return (_jsx("button", __assign({ className: cn(buttonVariants({ variant: variant, size: size, className: className })), ref: ref }, props)));
});
